...
ExtendedCauchyMatrix::ExtendedCauchyMatrix(const unsigned int rows, const unsigned int cols, const std::shared_ptr<Galois> GF):
...
ExtendedCauchyMatrix::ExtendedCauchyMatrix(const ExtendedCauchyMatrix::GeneratorVector &row, unsigned int rows, const std::shared_ptr<Galois> GF):
...
ExtendedCauchyMatrix::ExtendedCauchyMatrix(
  ...
  const ExtendedCauchyMatrix::GeneratorVector& col,
  const std::shared_ptr<Galois> GF):
